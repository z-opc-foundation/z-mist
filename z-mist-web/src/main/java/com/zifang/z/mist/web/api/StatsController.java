...
public class StatsController {
    ...
    public Map<String, Object> overview() {
        ...
        LambdaQueryWrapper<com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog> today =
                new LambdaQueryWrapper<>();
        today.ge(com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog::getGmtCreate, startOfDay);
        long todayOps = accessLogMapper.selectCount(today);
        LambdaQueryWrapper<com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog> failed =
                new LambdaQueryWrapper<>();
        failed.ge(com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog::getGmtCreate, startOfDay)
                .eq(com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog::getSuccess, false);
    ...
    public Map<String, Object> topSecrets(@RequestParam(defaultValue = "10") int limit) {
        ...
        LambdaQueryWrapper<com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog> wrapper =
                new LambdaQueryWrapper<>();
        wrapper.ge(com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog::getGmtCreate, since)
                .isNotNull(com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog::getSecretKey)
                .orderByDesc(com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog::getGmtCreate)
                .last("LIMIT 1000");
        List<com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog> logs =
                accessLogMapper.selectList(wrapper);
        Map<String, Long> counter = new HashMap<>();
        for (com.zifang.z.mist.core.domain.entity.ZMistSecretAccessLog l : logs) {
